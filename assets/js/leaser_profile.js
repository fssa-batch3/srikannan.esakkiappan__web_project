...
const user1 = JSON.parse(localStorage.getItem("leaser"));
const leas_log = JSON.parse(localStorage.getItem("profile_details"));
...
const place = document.getElementById("park_place");
