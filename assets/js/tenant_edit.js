...
const bike_img = document.getElementById("bike_img");
const bike_docs = document.getElementById("bike_docs");
const user_img = document.getElementById("user_img");
const tenant = JSON.parse(localStorage.getItem("Tenant_additional_det"));
const tenan_sign = JSON.parse(localStorage.getItem("Tenant_sign"));
const datas = JSON.parse(localStorage.getItem("Tenant"));
const profile = JSON.parse(localStorage.getItem("Tenant_details"));
console.log(datas);
console.log(profile);
...
const bikepic = document.getElementById("display_image");
function preview1() {
  bikepic.innerHTML = `<br><img src="${check.upload_image}" alt="Hv4a2Tv.jpg" border="0" height="260px" width="200px" >`;
}

const bikedoc = document.getElementById("display_docs");
function preview2() {
