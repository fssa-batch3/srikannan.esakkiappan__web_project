const main_box = document.querySelector(".present_box");

const histo = document.querySelector(".history_box");
...
const sttime = ans.parking_start_time;
const d = sttime.substring(0, 10);
const h = sttime.substring(11, 16);

const edtime = ans.parking_end_time;
const ed = edtime.substring(0, 10);
const eh = edtime.substring(11, 16);
...
accept.find((k) => {
  const accept_leas = k.Accepted_leaser;
