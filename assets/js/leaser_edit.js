...
const address = document.getElementById("subject");
const locat = document.getElementById("sub");
const pass = document.getElementById("pass");
const password = document.getElementById("password");
const land_img = document.getElementById("land_img");
const land_docs = document.getElementById("land_docs");
const user_img = document.getElementById("user_img");
const leas_sign = JSON.parse(localStorage.getItem("leas_signup"));
console.log(leas_sign);
const data = JSON.parse(localStorage.getItem("leaser"));
const dataa = JSON.parse(localStorage.getItem("leaser_modify_data"));
